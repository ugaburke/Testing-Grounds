...
enum TerrainType: Int, CaseIterable {
    ...
    var color: SKColor {
        ...
        case .forest: return SKColor(red: 0.12, green: 0.35, blue: 0.08, alpha: 1.0)
        case .water: return SKColor(red: 0.15, green: 0.38, blue: 0.65, alpha: 1.0)
        case .stone: return SKColor(red: 0.52, green: 0.52, blue: 0.50, alpha: 1.0)
        case .gold: return SKColor(red: 0.78, green: 0.68, blue: 0.15, alpha: 1.0)
        case .sand: return SKColor(red: 0.82, green: 0.73, blue: 0.52, alpha: 1.0)
        case .deepWater: return SKColor(red: 0.08, green: 0.2, blue: 0.48, alpha: 1.0)
        case .berryBush: return SKColor(red: 0.28, green: 0.42, blue: 0.15, alpha: 1.0)
        case .farm: return SKColor(red: 0.55, green: 0.48, blue: 0.22, alpha: 1.0)
        }
    }
...
enum BuildingType: CaseIterable {
    ...
    var color: SKColor {
        switch self {
        case .townCenter: return SKColor(red: 0.68, green: 0.52, blue: 0.28, alpha: 1.0)
        case .house: return SKColor(red: 0.62, green: 0.45, blue: 0.25, alpha: 1.0)
        case .barracks: return SKColor(red: 0.55, green: 0.38, blue: 0.28, alpha: 1.0)
        case .archeryRange: return SKColor(red: 0.48, green: 0.42, blue: 0.28, alpha: 1.0)
        case .stable: return SKColor(red: 0.52, green: 0.42, blue: 0.3, alpha: 1.0)
        case .blacksmith: return SKColor(red: 0.42, green: 0.38, blue: 0.35, alpha: 1.0)
        case .market: return SKColor(red: 0.65, green: 0.52, blue: 0.32, alpha: 1.0)
        case .castle: return SKColor(red: 0.55, green: 0.53, blue: 0.5, alpha: 1.0)
        case .farm: return SKColor(red: 0.55, green: 0.5, blue: 0.22, alpha: 1.0)
        case .lumberCamp: return SKColor(red: 0.52, green: 0.4, blue: 0.22, alpha: 1.0)
        case .miningCamp: return SKColor(red: 0.48, green: 0.45, blue: 0.38, alpha: 1.0)
        case .wall: return SKColor(red: 0.58, green: 0.55, blue: 0.52, alpha: 1.0)
        case .tower: return SKColor(red: 0.6, green: 0.57, blue: 0.52, alpha: 1.0)
        case .siegeWorkshop: return SKColor(red: 0.52, green: 0.38, blue: 0.22, alpha: 1.0)
        case .gate: return SKColor(red: 0.56, green: 0.54, blue: 0.5, alpha: 1.0)
        case .monastery: return SKColor(red: 0.62, green: 0.52, blue: 0.48, alpha: 1.0)
        case .dock: return SKColor(red: 0.45, green: 0.4, blue: 0.32, alpha: 1.0)
        case .university: return SKColor(red: 0.55, green: 0.48, blue: 0.42, alpha: 1.0)
        case .wonder: return SKColor(red: 0.78, green: 0.68, blue: 0.42, alpha: 1.0)
        case .outpost: return SKColor(red: 0.52, green: 0.48, blue: 0.42, alpha: 1.0)
...
enum UnitType: CaseIterable {
    ...
    var icon: String {
        ...
        case .uniqueUnit: return "★"
        case .batteringRam: return "🪵"
        case .mangonel: return "◎"
        case .longbowman: return "🏹"
        case .throwingAxeman: return "⚒"
        case .mangudai: return "🐎"
        case .cataphract: return "⛨"
        case .monk: return "✝"
        case .trebuchet: return "⚙"
        case .fishingBoat: return "🐟"
        case .tradeCart: return "🪙"
        case .warGalley: return "⛵"
        case .fireShip: return "🔥"
        case .petard: return "💣"
        case .camelRider: return "🐫"
        case .handCannoneer: return "💥"
        case .samurai: return "⚔"
        case .warElephant: return "🐘"
        case .chuKoNu: return "⊛"
        case .berserk: return "⚒"
        }
    }
